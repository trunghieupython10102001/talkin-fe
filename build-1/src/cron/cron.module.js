...
const livestream_module_1 = require("../gateway/livestream/livestream.module");
const schedule_1 = require("@nestjs/schedule");
let CronModule = class CronModule {
};
CronModule = __decorate([
    (0, common_1.Module)({
        imports: [schedule_1.ScheduleModule.forRoot(), share_module_1.ShareModule, livestream_module_1.LiveStreamModule],
        controllers: [],
